...
//    /// </summary>
//    internal class Pbkdf2HashProvider : IHashProvider
//    {
//        /// <summary>
//        /// 获取或设置盐（Salt）的字节大小。
...
//            return $"{HashAlgorithmType.Pbkdf2}${Iterations}${Convert.ToBase64String(saltBytes)}${Convert.ToBase64String(hash)}";
//        }
...
//                if (parts.Length != 4 || parts[0] != $"{HashAlgorithmType.Pbkdf2}") { return false; }

...
{
    /// <summary>
    /// AES-CTR（计数器模式）对称加密实现，依赖 BouncyCastle。
    /// CTR 适合流式加密，块大小为 16 字节，密钥为 SHA256(key)。
    /// </summary>
    public class AesCtrDataProvider : ISymmetricAlgorithm
    {
        /// <summary>使用 AES-CTR 模式加密明文。</summary>
        ...
        /// <summary>使用 AES-CTR 模式解密密文。</summary>

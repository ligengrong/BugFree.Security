...
{
    /// <summary>
    /// Twofish 对称加密算法实现（CBC模式，PKCS7填充，IV+密文Base64输出）。
    /// 依赖 BouncyCastle。Twofish 支持 128/192/256 位密钥，块大小为 16 字节。
    /// </summary>
    public class TwofishDataProvider : ISymmetricAlgorithm
    {
        /// <summary>
        /// 使用 Twofish 算法加密明文。
        /// </summary>
        ...
        public string Encrypt(string plainText, string key)
        {
            ...
            // Twofish 密钥长度 16/24/32 字节，超长自动截断
